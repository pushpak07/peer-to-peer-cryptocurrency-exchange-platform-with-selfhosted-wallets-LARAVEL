<app-admin-navigation inline-template>
	<nav class="header-navbar navbar-expand-md navbar navbar-with-menu navbar-hide-on-scrol navbar-without-dd-arrow fixed-top navbar-semi-dark navbar-shadow">
					...
					<ul class="nav navbar-nav float-right">
						...
						<li class="dropdown dropdown-notification nav-item">
							...
							<ul class="dropdown-menu dropdown-menu-media dropdown-menu-right">
								<li class="dropdown-menu-header">
									<h6 class="dropdown-header m-0">
										<span class="grey darken-2">{{__('Active Trade Chats')}}</span>
									</h6>
